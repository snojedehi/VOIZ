...
class UpdateRequest extends REST_Resource
{
    ...
    function HTTP_POST()
    {
        ...
        foreach($_POST["mobiles"] as $key=>$val){
            ...
            $q="
            INSERT INTO `asteriskcdrdb`.`novoip_callrequests_phones` (`id`, `number`,`exData`, `repeat`, `status`, `callDate`, `uniqueID`, `CID`) VALUES (NULL, '$val', '$ext','0', 'wating', '', '', '$_POST[CID]')
            ";
