...
{/if}
        ...
        <a href="http://www.novoip.ir" style="text-decoration: none;" target='_blank'>Snoip</a> is licensed under <a href="http://www.opensource.org/licenses/gpl-license.php" style="text-decoration: none;" target='_blank'>GPL</a>. 2006 - {$currentyear}.</div>
        ...
        <div class="fotter">
            <div class="copyr">
                <p>
                    Copyrights © 2017-2023 All Rights Reserved by <a href="http://www.novoip.io">اسنویپ</a>
                </p>  
            </div>
        </div>
